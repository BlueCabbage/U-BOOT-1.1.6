...
//	for (i = 0; i < 10; i ++);
//
//	*p = (page >> 8) & 0x0f; //Row Address A20 ~ A27
//	for (i = 0; i < 10; i ++);
//
...
//
///* Low level nand read function */
//int nand_to_sdram(unsigned char *buf, unsigned long start_addr, int size)
//{
//	int i, j;
//
//	if ((start_addr & NAND_BLOCK_MASK) || (size & NAND_BLOCK_MASK)) 
//	{
//		return -1;		// the length of address not align
//	}
//
//	NAND_CHIP_ENABLE;	// enable CS
//
//	for (i = start_addr; i < (start_addr + size); ) {
//		// send read0
//		// NAND_CLEAR_RB;
